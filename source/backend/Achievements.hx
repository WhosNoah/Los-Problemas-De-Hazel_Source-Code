...
class Achievements {
	public static function init()
	{
		...
		createAchievement('weekHazel_nomiss',       {name: "This is then last one song", description: "Beat the Hazel Weekend on Hard with no Misses."});
		createAchievement('weekHazel_normal',       {name: "This is a new beggining", description: "Beat the Hazel Week"});
		createAchievement('weekTBTB_perfect',       {name: "Go outside and touch some grass", description: "Beath the Hazel Week with a 100% on TBTB difficulty."});
		#end
